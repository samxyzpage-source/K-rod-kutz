/**
 * Road to Glory: QB — RTG.UI.Sprites (SPEC §4.2, D12)
 *
...
(function (root) {
  ...
  // ═══════════════════════════════ QB moment tiles (qb/ only — the kicker's atlas above is untouched) ═══════════════════════════════
  // Names are stable: qb/js/ui/playview.js indexes by name. Team tokens: 'J' = T1 (primary), 'N' = T2 (secondary),
  // so Sprites.get(name, {tint}) paints the home side in its colours and the defence in the opponent's.
  // Families end in a digit so Sprites.frames('qb_back') → ['qb_back0', 'qb_back1', 'qb_back2'].

  // ───────────────────────────── the quarterback (12×20), seen from behind: 0 set · 1 drop · 2 throw ─────────────────────────────
  def('qb_back0', [
    '....JJJJ....',
    '...JJJJJJ...',
    '...JNNNNJ...',
  ...
  // ───────────────────────────── receivers (8×12, home tint): run 0/1 · catch ─────────────────────────────
  def('receiver_run0', [
    '..JJJJ..',
    '..JNNJ..',
    '..JJJJ..',
  ...
  // ───────────────────────────── defenders (8×12, opponent tint): run 0/1 · set (pre-snap crouch) ─────────────────────────────
  def('defender_run0', [
    '..kkkk..',
    '..kJJk..',
    '..kkkk..',
  ...
  // ───────────────────────────── the O-line block (7×7, home tint) · the ball at its smallest ─────────────────────────────
  def('lineman_block', [
    '..JJJ..',
    '..JNJ..',
    '.JJJJJ.',
  ...
  // ───────────────────────────── openness rings (12×5 ellipses under a receiver; 'J' = the ring colour via tint) ─────────────────────────────
  // Three SHAPES as well as three colours (open solid / closing dashed / closed thick), so the colour-blind and
  // high-contrast palettes keep the states apart; the scene tints them with Palette.get('mint' | 'gold' | 'red').
  def('ring_open', [
    '...JJJJJJ...',
    '.JJ......JJ.',
    'J..........J',
  ...
  // ───────────────────────────── field numbers (5×7 chalk digits; 'yard' family) · aim glyphs ─────────────────────────────
  def('yard0', ['wwwww', 'w...w', 'w...w', 'w...w', 'w...w', 'w...w', 'wwwww']);
  def('yard1', ['..w..', '.ww..', '..w..', '..w..', '..w..', '..w..', 'wwwww']);
  def('yard2', ['wwwww', '....w', '....w', 'wwwww', 'w....', 'w....', 'wwwww']);
  def('yard3', ['wwwww', '....w', '....w', 'wwwww', '....w', '....w', 'wwwww']);
  def('yard4', ['w...w', 'w...w', 'w...w', 'wwwww', '....w', '....w', '....w']);
  def('yard5', ['wwwww', 'w....', 'w....', 'wwwww', '....w', '....w', 'wwwww']);
  def('yard6', ['wwwww', 'w....', 'w....', 'wwwww', 'w...w', 'w...w', 'wwwww']);
  def('yard7', ['wwwww', '....w', '....w', '...w.', '..w..', '..w..', '..w..']);
  def('yard8', ['wwwww', 'w...w', 'w...w', 'wwwww', 'w...w', 'w...w', 'wwwww']);
  def('yard9', ['wwwww', 'w...w', 'w...w', 'wwwww', '....w', '....w', 'wwwww']);
  def('lead_ahead', ['..w..', '.www.', 'wwwww', '..w..', '..w..']);   // the lead arrow (drawn ahead of / behind the receiver along its run)
